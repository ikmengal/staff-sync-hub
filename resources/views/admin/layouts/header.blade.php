            ...
            <div class="d-flex align-items-center me-7" id="kt_app_header_logo_wrapper">
                ...
                <a href="{{ route('dashboard') }}" class="d-flex align-items-center me-lg-20 me-5">
                    @if(isset(settings()->logo) && !empty(settings()->logo))
                        <img alt="Logo" src="{{ asset('public/admin/assets/img/logo') }}/{{ settings()->logo }}" class="h-20px d-sm-none d-inline" alt="{{ settings()->name }}" />
                        <img alt="Logo" src="{{ asset('public/admin/assets/img/logo') }}/{{ settings()->logo }}" class="h-20px h-lg-25px theme-light-show d-none d-sm-inline" alt="{{ settings()->name }}" />
                        <img alt="Logo" src="{{ asset('public/admin/assets/img/logo') }}/{{ settings()->logo }}" class="h-20px h-lg-25px theme-dark-show d-none d-sm-inline" alt="{{ settings()->name }}" />
                    @else
                        <img alt="Logo" src="{{ asset('public/admin') }}/assets/media/logos/demo-35-small.svg" class="h-20px d-sm-none d-inline" />
                        <img alt="Logo" src="{{ asset('public/admin') }}/assets/media/logos/demo-35.svg" class="h-20px h-lg-25px theme-light-show d-none d-sm-inline" />
                        <img alt="Logo" src="{{ asset('public/admin') }}/assets/media/logos/demo-35-dark.png" class="h-20px h-lg-25px theme-dark-show d-none d-sm-inline" />
                    @endif
                </a>
                <!--end::Logo-->
            </div>
        ...
        <div class="app-navbar flex-shrink-0">
            ...
            <div class="app-navbar-item">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
                    <!--begin::Heading-->
                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ asset('public/admin') }}/assets/media/misc/menu-header-bg.jpg')">
                        <!--begin::Title-->
                        ...
                        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                            ...
                            <div class="d-flex flex-column px-9">
                                ...
                                <div class="text-center px-4">
                                    <img class="mw-100 mh-200px" alt="image" src="{{ asset('public/admin') }}/assets/media/illustrations/sketchy-1/1.png" />
                                </div>
                                <!--end::Illustration-->
                            </div>
                            <!--end::Wrapper-->
                ...
                <div class="app-navbar-item ms-3 ms-lg-9" id="kt_header_user_menu_toggle">
                    ...
                    <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        ...
                        <div class="text-end d-none d-sm-flex flex-column justify-content-center me-3">
                            ...
                            <a href="{{ route('profile.edit') }}" class="text-gray-800 text-hover-primary fs-7 fw-bold d-block">{{ loginUser()->name }}</a>
                        </div>
                        <!--end:Info-->
                        <!--begin::User-->
                        <div class="cursor-pointer symbol symbol symbol-circle symbol-35px symbol-md-40px">
                            @if(!empty(loginUser()->profile))
                                <img class="" src="{{ asset('public/admin/assets/img/avatars') }}/{{ loginUser()->profile }}" alt="User Avatar" />
                            @else
                                <img class="" src="{{ asset('public/admin') }}/assets/media/svg/avatars/blank.svg" alt="User Avatar" />
                            @endif
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    @if(!empty(loginUser()->profile))
                                        <img alt="Avatar" src="{{ asset('public/admin/assets/img/avatars').'/'.loginUser()->profile }}" />
                                    @else
                                        <img alt="Avatar" src="{{ asset('public/admin') }}/assets/media/svg/avatars/blank.svg" />
                                    @endif
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        {{ loginUser()->name }}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Live</span>
                                    </div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ loginUser()->email }}</a>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ loginUser()->role }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ route('settings.create') }}" class="menu-link px-5">Settings</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
