    ...
    <div class="app-container container-xxl" id="kt_app_header_secondary_container">
        ...
        <div class="app-header-slider d-flex flex-stack h-100">
            ...
            <div class="tns tns-fit w-100">
                <!--begin::Slider-->
                <div data-tns="true" data-tns-loop="false" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="10000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-gutter="0" data-tns-responsive="{470: {items: 2}, 670: {items: 3, gutter: 15}, 992: {items: 5, gutter: 20}, 1300: {items: 4, gutter: 40}}" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_app_header_slider_prev" data-tns-next-button="#kt_app_header_slider_next">
                    @foreach (getAllCompanies() as $company)
                        <!--begin::Item-->
                        <a href="{{ $company->base_url }}" target="_blank" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                            <!--begin::Symbol-->
                            <div class="symbol symbol-35px symbol-lg-40px me-3">
                                <span class="symbol-label rounded-4" style="background-color: #f9f9f9">
                                    @if(!empty($company->favicon))
                                        <img src="{{ $company->base_url }}/public/admin/assets/img/favicon/{{ $company->favicon }}" class="mw-25px" alt="" />
                                    @endif
                                </span>
                            </div>
                            <!--end::Symbol-->
                            ...
                            <div class="d-flex justify-content-center flex-column">
                                <span class="fw-bold text-gray-800 parent-hover-primary fs-5 mb-1">{{ $company->name }}</span>
                                <span class="text-gray-500 fw-semibold d-block fs-7">{{ count($company->total_employees) }} Total Employees</span>
                            </div>
                            <!--end::Info-->
                        </a>
                        <!--end::Item-->
                    ...
                    <a href="pages/social/activity.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                        ...
                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                            <span class="symbol-label rounded-4" style="background-color: #E34984">
                                <img src="{{ asset('public/admin') }}/assets/media/svg/brand-logos/dribbble-2.svg" class="mw-25px" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Info-->
                    ...
                    <a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                        ...
                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                            <span class="symbol-label rounded-4" style="background-color: #00BF6D">
                                <img src="{{ asset('public/admin') }}/assets/media/svg/brand-logos/gab.svg" class="mw-25px" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Info-->
                    ...
                    <a href="pages/social/followers.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                        ...
                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                            <span class="symbol-label rounded-4" style="background-color: #001935">
                                <img src="{{ asset('public/admin') }}/assets/media/svg/brand-logos/tumblr.svg" class="mw-25px" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Info-->
                    ...
                    <a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                        ...
                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                            <span class="symbol-label rounded-4" style="background-color: #E60000">
                                <img src="{{ asset('public/admin') }}/assets/media/svg/brand-logos/youtube-2.svg" class="mw-25px" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Info-->
                    ...
                    <a href="pages/social/settings.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                        ...
                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                            <span class="symbol-label rounded-4" style="background-color: #0B66C3">
                                <img src="{{ asset('public/admin') }}/assets/media/svg/brand-logos/linkedin-3.svg" class="mw-25px" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Info-->
                    ...
                    <a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                        ...
                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                            <span class="symbol-label rounded-4" style="background-color: #2682ff">
                                <img src="{{ asset('public/admin') }}/assets/media/svg/brand-logos/eolic-energy.svg" class="mw-25px" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Info-->
                    ...
                    <a href="pages/social/followers.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                        ...
                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                            <span class="symbol-label rounded-4" style="background-color: #cfe2ff">
                                <img src="{{ asset('public/admin') }}/assets/media/svg/brand-logos/vimeo.svg" class="mw-25px" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Info-->
                    ...
                    <a href="pages/social/feeds.html" class="parent-hover cursor-pointer d-flex align-items-center flex-md-row-fluid py-lg-2 px-0">
                        ...
                        <div class="symbol symbol-35px symbol-lg-40px me-3">
                            <span class="symbol-label rounded-4" style="background-color: #f1aeb5">
                                <img src="{{ asset('public/admin') }}/assets/media/svg/brand-logos/foursquare.svg" class="mw-25px" alt="" />
                            </span>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Info-->
