...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-1"><span class="text-muted fw-light">User Profile /</span> Profile</h4>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pb-3">
        <!--begin::Item-->
                        ...
                        <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
                            <div class="user-profile-info">
                                ...
                                <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                                    <li class="list-inline-item"><i class="ti ti-color-swatch"></i>{{ !empty($model) ? getMyRole()  : "" }}</li>
                                    <li class="list-inline-item"><i class="ti ti-map-pin"></i>{{ !empty($model) ? getUserData($model)->designation : "" }}</li>
                                    <li class="list-inline-item"><i class="ti ti-calendar"></i>
                                        {{ !empty($model) ? getUserData($model)->email : ""}}
                                    </li>
                                </ul>
                            </div>
