                    ...
                    <span class="card-title mb-0">
                        ...
                        <div class="user-profile-header mt-4 d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                            <div class="flex-shrink-0 mt-2 mx-sm-0 mx-auto">
                                ...
                                @else
                                    <img src="{{ asset('public/admin') }}/default.png" alt="Default image" width="70"
                                        height="70" class="d-block rounded-circle object-fit-cover" />
                                @endif
                            </div>
                                    ...
                                    @can('generate_pay_slip-create')
                                        @if ($user->employeeStatus->end_date != null)
                                            ...
                                            @if ($monthYear > date('m/Y', strtotime($user->employeeStatus->end_date)))
                                                @php
                                                    $month = date('m', strtotime($user->employeeStatus->end_date));
                                                    $year = date('Y', strtotime($user->employeeStatus->end_date));
                                                @endphp
                                            @endif
                                        @endif
                                        @if (!isset($message))
                                            <a href="{{ URL::to('employees/generate_salary_slip/' . $month . '/' . $year . '/' . $user->slug) }}"
                                    ...
                                    <table class="table-striped table mt-3 salary-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="mb-0 text-center">{{ $currency_code ?? 'Rs.' }} 0
                                                    </p>
                                                </td>
                                                <td>
                                                    <p class="mb-0 text-center">{{ $currency_code ?? 'Rs.' }} 0
                                ...
                                <div class="col-sm-6">
                                    <table class="table-striped table mt-3 salary-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <h6 class="mb-0">Income Tax (will be calculated at the time
                                                        of salary)
                                                </td>
                                                <td>
                                                    <p class="mb-0 text-center">{{ $currency_code ?? 'Rs.' }} 0
