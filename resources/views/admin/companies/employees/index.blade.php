...
@if(isset($company) && !empty($company))
    <input type="hidden" id="page_url" value="{{ route('admin.company.employees', $company) }}">
@elseif(isset($data['status']) && !empty($data['status']))
    <input type="hidden" id="page_url" value="{{ route('admin.companies.employees.new_hiring') }}">
@else
    <input type="hidden" id="page_url" value="{{ route('admin.companies.employees') }}">
@endif
