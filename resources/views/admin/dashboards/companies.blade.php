                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                ...
                                <img src="{{ $company->base_url }}/public/admin/assets/img/favicon/{{ $company->favicon }}" alt="{{ $company->name }}" width="170" class="card-website-analytics-img" />
                                @else
                                <img src="{{ asset('public/admin/default.png') }}" alt="Default Logo" width="170" class="card-website-analytics-img" />
                                @endif
                            </div>
                        </div>
                    </div>
