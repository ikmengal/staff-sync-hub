            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="dt-buttons btn-group flex-wrap float-end mt-4">
                        @can('users-create')
                        <button id="add-btn" data-modal-id="createUserModal" data-toggle="tooltip" data-placement="top" title="Add User" data-url="{{ route('users.create') }}" class="btn add-new btn-primary mb-3 mb-md-0 mx-3" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="modal">
                            <span>
        ...
        <div class="card">
            <div class="row p-3">
                ...
                <div class="col-md-2 mt-3 py-1">
                    ...
                    <button type="button" class="btn btn-danger refreshBtn">Reset <i class="fa-solid fa-filter"></i></button>
                </div>
            </div>
