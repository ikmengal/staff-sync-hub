...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ asset('public/admin') }}/assets/" data-template="vertical-menu-template">
...
<head>
  ...
  <!-- Page CSS -->
  <!-- Page -->
  <link rel="stylesheet" href="{{ asset('public/admin') }}/assets/vendor/css/pages/page-misc.css" />
  <!-- Helpers -->
